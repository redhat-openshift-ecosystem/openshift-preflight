...
// getDataForValidate is a helper function to obtain the labels from an images configfile
func getDataForValidate(image cranev1.Image) (map[string]string, error) {
